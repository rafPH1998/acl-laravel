...
<div class="lg:flex p-10 lg:items-center lg:justify-between">
    <div class="min-w-0 flex-1 flex justify-between">
        ...
        <a href="{{route('users.create')}}" type="button" class="inline-flex items-center rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">
            Cadastrar
        </a>
    </div>
</div>
    ...
    <table class="min-w-full shadow-lg mt-2 border">
        <thead class="bg-white border-b">
            <tr>
                ...
                <th scope="col" class="text-sm font-medium text-gray-900 px-3 py-2 md:px-6 md:py-4 text-left">E-MAIL</th>
                    ...
                    <td class="text-sm text-gray-900 font-light px-3 py-2 md:px-6 md:py-4 whitespace-nowrap">
                        <div class="flex">
                           <a href="{{route('users.edit', $user->id)}}">
                            ...
                            <form action="{{ route('users.destroy', $user->id) }}" method="POST" id="form-delete-{{ $user->id }}" style="display: none;">
                                @csrf
                                @method("DELETE")
                            </form>
                        </div>
